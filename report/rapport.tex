...
The algorithm uses $O(|W|k)$ space, since it has to maintain $W$ individual sketches, each of size $k$. It is worth noting, that the space usage is independent of the input size $n$. This is only a factor $|W|$ more than TODO PAGH REF, which is to be expected.
  %io
